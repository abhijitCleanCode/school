    ...
    >
      <td className="flex items-center gap-4 p-4">
        ...
        <div className="flex flex-col">
          ...
          <p className="text-xs text-gray-600">Teacher: Raj</p>
        </div>
      </td>
  ...
  return (
    <section>
      <div className="flex items-center justify-between flex-wrap">
        <h1 className="text-2xl font-normal">Class 1</h1>
...
export default SubjectList_classes;
